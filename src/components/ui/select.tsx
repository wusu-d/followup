...
>(({ className, children, iconColor = '#111111', ...props }, ref) => (
  <>
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-10 w-full items-center justify-between rounded-md border border-neutral-200 bg-white px-3 py-2 ring-offset-white placeholder:text-[#1111117A] text-lg font-medium focus-visible:outline-none focus:outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 ',
        className
      )}
      {...props}
    >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-pointer font-medium select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-[#0F172A] text-base outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:bg-[#F2F5F8]',
      className
    )}
    {...props}
  >
