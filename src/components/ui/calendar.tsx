    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-primary-green'
        ),
        ...
        day: cn(
          ...
          'h-9 w-9 p-0 font-normal rounded-full hover:bg-primary-green/50 hover:text-black aria-selected:opacity-100'
        ),
        day_range_end: 'day-range-end',
        day_selected:
          'bg-primary-green text-white hover:bg-primary-green hover:text-white focus:bg-primary-green focus:text-white',
        day_today:
          'bg-primary-green/10 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50',
        day_outside:
      ...
      components={{
        IconLeft: ({ ...props }) => (
          <ChevronLeft {...props} className='h-4 w-4 text-primary-green' />
        ),
        IconRight: ({ ...props }) => (
          <ChevronRight {...props} className='h-4 w-4 text-primary-green' />
        ),
      }}
      {...props}
    />
